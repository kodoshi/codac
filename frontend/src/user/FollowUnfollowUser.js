...
render() {
    ...
    <div>
    {
    	...
    	(
    		<button className="btn btn-raised btn-primary mr-5" onClick={()=>this.followClick()}> Follow </button>
    	) : 
    	(
    		<button className="btn btn-raised btn-danger mr-5" onClick={()=>this.unfollowClick()}> UnFollow </button>
    	)
    }
